...
public class InputStreamReaderTest {
	...
	throws IOException
	{
		...
		//String fname="C:\\Users\\PC\\git\\firstGit\\Begin\\readme.txt"; 계속깨짐;;//ANSI로 저장 ==>CP949=>EUC-KR 등 인코드의 캐릭값에 따라 맞춰줌
		...
		InputStreamReader fr=new InputStreamReader(fis,"UTF-8");//읽고//UTF-8 : properties에서 나옴
		
		OutputStreamWriter ow=new OutputStreamWriter(System.out,"UTF-8");//내보냄 //
		int n=0;
		while((n=fr.read())!=-1) {
			ow.write(n);
			ow.flush();
